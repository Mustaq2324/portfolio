...
function services() {
  return (
   ...
   <div className='flex flex-col items-center'>     {/*STARTER */}
    <h1 className='font-bold text-5xl  mt-7'>SERVICES</h1>
      ...
      <p className='h-2 w-[50px] mt-3  bg-orange-400'></p>
             ...
             <div> {/* ICONS */}
              ...
              <div className='mt-10 flex flex-col items-center bg-white'>    {/* NO1 */}
               ...
               <div  className='shadow-xl shadow-slate-600 p-4  mt-8'>
               <div className='mt-10 flex flex-col items-center'>    {/* NO2 */}
               ...
               <div className='shadow-xl shadow-slate-600 p-4  mt-8' >
               <div className='mt-10 flex flex-col items-center'>    {/* NO3 */}
               ...
               <div  className='shadow-xl shadow-slate-600 p-4  mt-8'>
               <div className='mt-10 flex flex-col items-center'>    {/* NO4 */}
               ...
               <div className='shadow-xl shadow-slate-600 p-4 mt-8'>
                   <div className='mt-10 flex flex-col items-center'>    {/* NO5 */}
